...
@Mode Console /* Mode choices: Console & Panel */
...
/* Line.Expression:string Circle.Expression */
...
Println("Intersection length: ",line1.Intersect(circle1));
End
